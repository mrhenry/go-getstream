...
// get request helper
func (f *AggregatedFeed) get(path string, signature string, payload []byte) ([]byte, error) {
...
func (f *AggregatedFeed) del(path string, signature string, payload []byte) error {
